Feature: Forgot Password - Valid and Invalid data for Corporate Customer
  ...
  Scenario: Verifying if user is able to proceed to the OTP Channel Selection page using valid set of login password data
    ...
    Then I enter valid username and registration number - SPWD for Corporate Customer
  ...
  Scenario: Verifying if user is able to proceed to the OTP Channel Selection page using valid set of transaction password data
      ...
      And I click on the Click here link for Corporate Customer
    Then I should be displayed with the Forgot password page for Corporate Customer
    Then I enter valid username and registration number - TPWD for Corporate Customer
      And I close the browser
  ...
  Scenario: Verifying if user is displayed with error pop-up using invalid set of login password data
      ...
      And I click on the Click here link for Corporate Customer
    Then I should be displayed with the Forgot password page for Corporate Customer
    Then I enter invalid username and registration number - SPWD for Corporate Customer
      And I close the browser
  ...
  Scenario: Verifying if user is displayed with error pop-up using invalid set of transaction password data
      ...
      And I click on the Click here link for Corporate Customer
    Then I should be displayed with the Forgot password page for Corporate Customer
    Then I enter invalid username and registration number - TPWD for Corporate Customer
      And I close the browser
