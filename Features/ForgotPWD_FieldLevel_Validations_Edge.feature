Feature: Field Level Validations for all customer types
  ...
  Scenario: Verifying warning message for disallowed characters in username field for Mongolian Customer
  ...
  Scenario: Verifying warning message for disallowed characters in username field for Foreign Customer
    Given I initiate the Microsoft Edge Browser
      And I launch the Khan Bank application in Retail Domain
    When I click on Forgot Password link
      And I select the login password to be reset
  ...
  Scenario: Verifying warning message for disallowed characters in username field for Corporate Customer
    Given I initiate the Microsoft Edge Browser
